...
public class DList extends List {
    ...
    public void insertFront(Object item) {
        ...
        {
            DListNode s = newNode(item, this, head, head.next);
            head.next = s;
            s.next.prev = s;
            size++;
        }
    ...
    public void insertBack(Object item) {
        ...
        {    
            DListNode s = newNode(item, this, head.prev, head);
            head.prev = s;
            s.prev.next = s; 
            size++;
        }
    ...
    /**
     * Standard Java interface for iteration. Iterator constructor returns an SListIterator object
     */
